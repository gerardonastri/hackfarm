      ...
      <div className="max-w-[1700px] mx-auto px-4 lg:px-[3rem] sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 lg:mb-[150px]">
          <motion.div
            ...
            className="relative"
          >
            <h2 className="text-6xl lg:text-8xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-secondary to-red-600">
              Phaser Game
              <br />
              Jam
            </h2>
            <div className="absolute -bottom-4 left-0 w-24 h-1 bg-gradient-to-r from-secondary to-red-600" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
              ...
              <Link href={`/phaser/${edition.id}`} className="block h-full">
                ...
                <div className="absolute inset-0 flex items-center justify-center transform transition-transform duration-500 group-hover:translate-y-0">
                  <div className="text-center transform transition-all duration-500 group-hover:scale-110">
                    <p className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-secondary to-red-500 mb-2">
                      {edition.year}
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            >
              <p className="text-white/80 leading-relaxed text-lg xl:max-w-[90%]">
                ...
                creazione dei videogiochi. Questo evento offre
                un&apos;esperienza unica di apprendimento pratico e rappresenta
                un&apos;opportunità unica per apprendere e mettere in pratica
                competenze tecniche in un contesto stimolante e creativo.
              </p>
              <div className="w-full h-px bg-gradient-to-r from-orange-500/20 to-transparent" />
            </motion.div>
            ...
            >
              <p className="text-white/80 leading-relaxed text-lg">
                L&apos;evento è creare un videogioco originale e funzionale in
                un tempo limitato, dimostrando creatività, capacità di
                problem-solving e lavoro di squadra. Questa sfida non è solo
                un&apos;attività divertente, ma anche un&apos;importante
                opportunità di apprendimento pratico in un ambiente
